...
def init(tbuildir, distdir, rootdir, blddir, rdir, ardir, srdir, sdir, cdir):
    ...
    _cbdir = pathlib.Path(tbuildir) / "tbuild"
...
def prepare():
    ...
    (tbuild_cache() / "apk").mkdir(parents=True, exist_ok=True)
