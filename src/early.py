...
def fire():
    # we need structural pattern matching in templates and tbuild itself
    ...
    # stuff needed to import the rest of tbuild correctly
    runner.init_late()
